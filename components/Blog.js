  ...
  return (
    <>
        <div className=' lg:pb-48 pb-14'>
            <div className="md:px-28 lg:px-40 px-7  mx-auto text-center">
                <div className='relative flex justify-center'>
                    <h1 className=' stk font-SF-Bold md:text-96  text-33 text-white'>BLOG</h1>
                    <h2 className=' font-Futura md:text-59 text-2xl text-black  absolute bottom-2 md:bottom-14  '>Our Latest Blog</h2>
            ...
            <div className=' lg:flex md:mx-36 mx-7 lg:items-center md:mb-9 mb-5 '>
                <div className=' lg:mr-8 mb-6 lg:mb-0'>
                   <div className=' relative md:mb-9 mb-3 object-cover '>
                        <Image src="/assets/blog1 (2).png" width={407} height={252} alt="blog1"/>
                        <div className=' bg-menu-bg  md:w-16  w-8 absolute bottom-5 left-3 text-center'>
                   ...
                   <div className=' flex items-center'>
                       <div className='flex items-center mr-5'>
                           <div className=' mr-2'>
                                <Image src="/assets/admin.png" width={10} height={10} alt="admin"/>
                           </div>
                           <p className=' font-SF-Regular md:text-sm text-xs text-t-grey-6'>ADMIN</p>
                       </div>
                       <div className='flex items-center mr-5'>
                           <div className=' mr-2'>
                                <Image src="/assets/calendar.png" width={10} height={10} alt="calendar"/>
                           </div>
                           <p className=' font-SF-Regular md:text-sm text-xs text-t-grey-6'>23 JAN</p>
                       </div>
                       <div className='flex items-center'>
                           <div className=' mr-2'>
                                <Image src="/assets/message.png" width={10} height={10} alt="message"/>
                           </div>
                ...
                <div className='lg:mr-8 mb-6 lg:mb-0' >
                   <div className=' relative md:mb-9 mb-3'>
                        <Image src="/assets/blog2 (2).png" width={407} height={252} alt="blog2"/>
                        <div className=' bg-menu-bg  md:w-16  w-8 absolute bottom-5 left-3 text-center '>
                ...
                <div className='lg:mr-8' >
                   <div className=' relative md:mb-9 mb-3'>
                        <Image src="/assets/blog3 (2).png" width={407} height={252} alt="blog3"/>
                        <div className=' bg-menu-bg  md:w-16  w-8 absolute bottom-5 left-3 text-center '>
        ...
        <div className=' bg-border-white'>
            <div className='   max-w-1200 bg-menu-bg mx-auto lg:rounded-3xl lg:relative lg:bottom-20 md:py-24 md:px-20 py-11 px-10'>
                <div className='lg:flex justify-between   '>
                    <div className=' lg:mr-16 '>
                        ...
                        <img src="/assets/mail.png" alt="mail" className=' opacity-20 lg:absolute lg:bottom-0 hidden lg:block ' />
                    </div>
